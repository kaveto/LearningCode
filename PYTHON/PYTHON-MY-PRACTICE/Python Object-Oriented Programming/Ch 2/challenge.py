...
msft = Stock("MSFT","Microsoft Corp", Price(342.0))
goog = Stock("GOOG", "Google Inc",  Price(135.0))
meta = Stock("META", "Meta Platforms Inc",  Price(275.0))
amzn = Stock("AMZN", "Amazon Inc",  Price(135.0))

us30yr = Bond("30 Year US Treasury", 30, 4.38, Price(95.31))
us10yr = Bond("10 Year US Treasury", 10, 4.28, Price(96.70))
us5yr = Bond("5 Year US Treasury", 5, 4.43, Price(98.65))
us2yr = Bond("2 Year US Treasury", 2, 4.98, Price(99.57))
